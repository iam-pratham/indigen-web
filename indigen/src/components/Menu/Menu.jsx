      ...
      <div className="menu-overlay" ref={menuOverlayRef}>
        <div className="menu-content">
          ...
          >
            ...
            <div className="menu-content-group">
              <p>Email</p>
              <p>support@indigenservices.com</p>
            </div>

            <div className="menu-content-group">
              <p>Website</p>
              <p>indigenservices.com</p>
            </div>
          </div>
          <div
            className="menu-col"
          ...
          >
            ...
            <div className="menu-content-group">
              <p>Mission</p>
              <p>Make businesses smarter and future-ready</p>
            </div>

            <div className="menu-content-group">
              <p>About</p>
              <p>AI & SaaS Development Company</p>
              <p>Full-Stack Innovation Partner</p>
            </div>
          </div>
        </div>
